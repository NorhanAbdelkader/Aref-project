...
return (rateForStar*100)/totalReviews
   ...
   <div className="reviwes-item">
    {  rate.reverse().map((num,_index)=>{
return(<div className="reviwes-bar"><p>{(5-_index).toString().replace(/\d/g, (d) => String.fromCharCode(1632 + parseInt(d)))}</p><RatingBar rateValue={getPercentRate(num)}/> </div>)})}
